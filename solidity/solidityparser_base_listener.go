...
// EnterCreateNewExpression is called when production CreateNewExpression is entered.
func (s *BaseSolidityParserListener) EnterCreateNewExpression(ctx *CreateNewExpressionContext) {}

// ExitCreateNewExpression is called when production CreateNewExpression is exited.
func (s *BaseSolidityParserListener) ExitCreateNewExpression(ctx *CreateNewExpressionContext) {}

// EnterCreateNewExpressionContext is called when production createNewExpressionContext is entered.
func (s *BaseSolidityParserListener) EnterCreateNewExpressionContext(ctx *CreateNewExpressionContextContext) {
}

// ExitCreateNewExpressionContext is called when production createNewExpressionContext is exited.
func (s *BaseSolidityParserListener) ExitCreateNewExpressionContext(ctx *CreateNewExpressionContextContext) {
}
