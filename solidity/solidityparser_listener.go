...
type SolidityParserListener interface {
	...
	// EnterCreateNewExpression is called when entering the CreateNewExpression production.
	EnterCreateNewExpression(c *CreateNewExpressionContext)

	// EnterCreateNewExpressionContext is called when entering the createNewExpressionContext production.
	EnterCreateNewExpressionContext(c *CreateNewExpressionContextContext)
	...
	// ExitCreateNewExpression is called when exiting the CreateNewExpression production.
	ExitCreateNewExpression(c *CreateNewExpressionContext)

	// ExitCreateNewExpressionContext is called when exiting the createNewExpressionContext production.
	ExitCreateNewExpressionContext(c *CreateNewExpressionContextContext)
