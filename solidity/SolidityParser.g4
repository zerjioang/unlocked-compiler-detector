...
//@doc:inline
parameterDeclaration: varType=typeName location=dataLocation? name=identifier?;
/**
 ...
 */
structMember: varType=typeName name=identifier Semicolon;
/**
 ...
 */
eventParameter: varType=typeName Indexed? name=identifier?;
/**
 ...
 */
errorParameter: varType=typeName name=identifier?;
/**
...
elementaryTypeName[boolean allowAddressPayable]: Address | {$allowAddressPayable}? Address Payable | Bool | StringLiteral | Bytes | SignedIntegerType | UnsignedIntegerType | FixedBytes | Fixed | Ufixed;
functionTypeName
 ...
 */
variableDeclaration: varType=typeName location=dataLocation? name=identifier;
...
expression:
	...
	| createNewExpressionContext # CreateNewExpression
...
createNewExpressionContext: New typeName;
